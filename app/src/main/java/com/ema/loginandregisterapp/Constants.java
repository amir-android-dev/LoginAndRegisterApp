...
public class Constants {
    ...
    public static final String INTENT_FIRSTNAME = "intent_firstname";
    public static final String INTENT_LASTNAME = "intent_lastname";
    public static final int INTENT_START_ACTIVITY_FOR_RESULT = 111;
